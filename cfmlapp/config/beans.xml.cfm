...
<beans>
	...
	<bean id="departmentService" class="distroManagerAJAX.services.Department" singleton="true">
	</bean>

	<bean id="buildService" class="distroManagerAJAX.services.Build" singleton="true">
	</bean>

	<bean id="distroService" class="distroManagerAJAX.services.Distro" singleton="true">
		<argument name="departmentService">
			<ref bean="departmentService" />
		</argument>
		<argument name="buildService">
